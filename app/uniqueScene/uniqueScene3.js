...
const audio = require('../../public/audio/cuento/primerSoplidos.mp3');

const uniqueScene3 = ({ navigation }) => {
    ...
    const goToEsena1 = () => {
        navigation.replace('uniqueScene4');
    };
    ...
    return (
        <View style={homeStyles.container}>
            ...
            <Image source={require('../../public/img/fondos/Fondo1.png')} style={[homeStyles.imagenFondo]}></Image>
                <Image source={require('../../public/img/cuentos/41.png')} style={[homeStyles.imageIntro]} />
            </TouchableOpacity>
        </View>
    );
};

export default uniqueScene3;

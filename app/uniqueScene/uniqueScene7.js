...
const audio = require('../../public/audio/cuento/escapeCasaTocino.mp3');

const uniqueScene7 = ({ navigation }) => {
    ...
    return (
        <View style={homeStyles.container}>
            <TouchableOpacity style={homeStyles.button} onPress={goToEsena1} disabled={isAudioPlaying}>
                <Image source={require('../../public/img/cuentos/44.png')} style={[homeStyles.imageIntro]} />
            </TouchableOpacity>
        </View>
    );
};

export default uniqueScene7;
